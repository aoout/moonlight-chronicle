...
/** @type {{ [key: string]: { name: string, icon: string, color: string, fmt: (v: number) => string | number } }} */
export const STATS = {
...
export const STAT_ORDER = ['maxHp','armor','speed','atk','atkSpd','critRate','critDmg','lifesteal','regen','projCount','area','duration','luck','xpGain','goldGain','dodge','cdr','magnet','thorns'];
