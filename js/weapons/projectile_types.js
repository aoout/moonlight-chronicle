...
/**
 * @typedef {Object} ProjectileTypeContext
 * @property {number} angle
 * @property {any} target
 * @property {any} p
 * @property {any} cfg
 * @property {any} projCfg
 * @property {string} wId
 ...
 *
 * @type {Record<string, { createFlags: (ctx: ProjectileTypeContext) => Record<string, any>, movement: string, hit: string, onHit: string[] }>}
 */
export const PROJECTILE_TYPES = {
  /** 回旋镖 */
  boomerang: {
    /** @param {ProjectileTypeContext} _ctx */
  ...
  /** 追踪 */
  homing: {
    /** @param {ProjectileTypeContext} ctx */
 ...
 * @returns {string}
 */
export function resolveProjectileType(pr) {
