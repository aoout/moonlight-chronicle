/* =========================================================
   蚀月远征 · 基准测试：报告生成与对比工具
   ========================================================= */
import type { BenchReport, BenchResult, BenchComparison, DeltaRow, EntityCounts } from './types.js';
...
export function generateReportText(report: BenchReport): string {
  ...
  for (const r of report.results) {
    ...
    lines.push('');
    lines.push(`  [${r.name}]  ${r.frameCount} 帧 / ${r.duration}s 采样`);
...
<div class="footer">
  流畅=≤60fps(16.67ms) | 可玩=30-60fps(16.67-33.33ms) | 卡顿=&lt;30fps(33.33ms+)
</div>
</body>
</html>`;
}
